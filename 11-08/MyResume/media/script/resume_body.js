...
function plotBothPages() {
    ...
    svg.append("path")
        .attr("d", bookmarkSection(xStart + mainPageWidth + secondRadius * 2 + 1, yStart + pageOffset + bookmarkOffset + bookmarkHeight * 2, bookmarkTopWidth, bookmarkBottomWidth, bookmarkHeight, secondRadius))
    ...
    drawBookMarkText(svg, pageNames[0].label, xStart + mainPageWidth + secondRadius * 2 + 1, yStart + pageOffset + bookmarkOffset + bookmarkHeight * 2, bookmarkTopWidth, bookmarkHeight, pageNames[0].id);

    svg.append("path")
        .attr("d", bookmarkSection(xStart + mainPageWidth + secondRadius + 1, yStart + pageOffset + bookmarkOffset + bookmarkHeight, bookmarkTopWidth, bookmarkBottomWidth, bookmarkHeight, secondRadius))
    ...
    drawBookMarkText(svg, pageNames[1].label, xStart + mainPageWidth + secondRadius + 1, yStart + pageOffset + bookmarkOffset + bookmarkHeight, bookmarkTopWidth, bookmarkHeight, pageNames[1].id);
